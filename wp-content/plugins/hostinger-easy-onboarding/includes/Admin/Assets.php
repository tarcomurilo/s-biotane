        ...
        if ( $this->utils->isThisPage( $admin_path . 'admin.php?page=hostinger-get-onboarding' ) ||
            ...
            $localize_data = array(
                ...
                'translations'          => array(
                    ...
                    'hostinger_easy_onboarding_reach_banner_title'                                  => __( 'Turn site visitors into loyal customers', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_reach_banner_description'                            => __( 'Collect emails from forms on your site and start sending on-brand email campaigns, powered by AI. Start free.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_reach_get_started'                                   => __( 'Install plugin', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_reach_activate_plugin'                               => __( 'Activate plugin', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_reach_not_interested'                                => __( 'Not interested', 'hostinger-easy-onboarding' ),
                    ...
                    'hostinger_easy_onboarding_domain'                                              => __( 'Domain', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_suspended'                                           => __( 'Suspended', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_connecting'                                          => __( 'Connecting', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_not_connected'                                       => __( 'Not connected', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_learn_more'                                          => __( 'Learn more', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_temporary'                                           => __( 'Temporary', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_not_purchased'                                       => __( 'Not purchased', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_registered_at_another_provider'                      => __( 'Registered at another provider', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_being_reviewed'                                      => __( 'Being reviewed', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_registration_didnt_work'                             => __( 'Registration didn\'t work', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_registering'                                         => __( 'Registering', 'hostinger-easy-onboarding' ),
                    ...
                    'hostinger_easy_onboarding_domain_needs_setup'                                  => __( 'Domain needs setup', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_transfer'                                            => __( 'Transfer', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_try_again'                                           => __( 'Try again', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_pending_email_verification'                          => __( 'Pending email verification', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_pending_phone_verification'                          => __( 'Pending phone verification', 'hostinger-easy-onboarding' ),
