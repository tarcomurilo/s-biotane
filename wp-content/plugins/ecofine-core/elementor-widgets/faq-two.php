...
class eco_accordion_two_Widget extends Widget_Base
{

    public function get_name()
    {

        return 'eco_accordion_two';
    }
    public function get_title()
    {
        return esc_html__('Eco Faq V2', 'ecofinecore');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .eco-faq-two-wraper ' => 'text-align: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'eco_faq_css_title_bg',
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .eco-faq-two-wraper .faq-accordion .accordion-button',
            ]
        );
        $this->add_control(
            'active_bg_color',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .eco-faq-two-wraper .accordion-header .accordion-button:not(.collapsed)' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'eco_faq_css_box_bg_active',
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .eco-faq-two-wraper .accordion-header .accordion-button:not(.collapsed)',
            ]
        );
        $this->add_responsive_control(
            'eco_faq_css_title_border',
            [
                'label' => esc_html__('Border Color', 'ecofinecore'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .eco-faq-two-wraper .faq-accordion .accordion-button.collapsed' => 'border-color: {{VALUE}} !important;',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .eco-faq-two-wraper .faq-accordion .accordion-button.collapsed' => 'border-radius: {{SIZE}}{{UNIT}} !important;',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__('Shadow', 'ecofinecore'),
                'selector' => '{{WRAPPER}} .eco-faq-two-wraper .faq-accordion .accordion-button.collapsed',
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .eco-faq-two-wraper .faq-accordion .accordion-item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .eco-faq-two-wraper .faq-accordion .accordion-button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name'     => 'eco_icon_typo',
                'label'    => esc_html__('Typography', 'ecofinecore'),
                'selector' => '{{WRAPPER}} .faq-accordion .accordion-button::after,{{WRAPPER}} .faq-accordion .accordion-button::before',
            ]
        );
        $this->add_responsive_control(
            'icon_color',
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .faq-accordion .accordion-button::before' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .accordion-header .accordion-button:not(.collapsed)::before' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
...
Plugin::instance()->widgets_manager->register(new eco_accordion_two_Widget);
