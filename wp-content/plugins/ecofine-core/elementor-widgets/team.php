...
class ecofine_Team_Widget extends Widget_Base
{
    ...
    {
        return esc_html__('Eco Team V1', 'ecofinecore');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('our experts', 'ecofinecore'),
                'condition' => [
                    'enable_title' => 'yes',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Become a part of the green scene', 'ecofinecore'),
                'condition' => [
                    'enable_title' => 'yes',
                ],
            ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'space-between' => [
                        'title' => esc_html__('Space Between', 'ecofinecore'),
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .team-items' => 'justify-content: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .team-items' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .eco-team-image img' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eco-team-image img' => 'object-fit: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'name'     => 'image_border',
                'label'    => esc_html__('Border', 'ecofinecore'),
                'selector' => '{{WRAPPER}} .eco-team-image img',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .eco-team-image' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .eco-team-image ',
            ]
        );
        $this->add_responsive_control(
            'image_margin',
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .eco-team-image' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .eco-team-image' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-title a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-stitle' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .team-stitle' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .team-stitle' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Typography', 'ecofinecore'),
                'selector' => '{{WRAPPER}} .team-content ul li a',
            ]
        );
        $this->add_responsive_control(
            'social_icon_color',
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-content ul li a' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-content ul li a' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-content ul li a' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-content ul li a' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-content ul li a' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .team-content ul li a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .team-content ul li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-content ul li a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-content ul li a:hover' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Border', 'ecofinecore'),
                'selector' => '{{WRAPPER}} .team-content ul li a:hover',
            ]
        );
        $this->add_responsive_control(
            'social_icon_hradius',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-content ul li a:hover' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->start_controls_section(
            'arrow_css',
            [
                'label' => esc_html__('Arrow Icon and Dots', 'ecofinecore'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'enable_slide' => 'yes',
                ],
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'arrow_typo',
                'label' => esc_html__('Typography', 'ecofinecore'),
                'selector' => '{{WRAPPER}} .team-arrow-wrapper .slick-arrow',
            ]
        );
        $this->add_responsive_control(
            'arrow_color',
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-arrow-wrapper .slick-arrow' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-arrow-wrapper .slick-arrow' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-arrow-wrapper .slick-arrow' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-arrow-wrapper .slick-arrow' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-arrow-wrapper .slick-arrow' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .team-arrow-wrapper .slick-arrow' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .team-arrow-wrapper .slick-arrow' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-arrow-wrapper .slick-arrow:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            'arrow_hbg',
            [
                'label' => esc_html__('Hover BG', 'ecofinecore'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .team-arrow-wrapper .slick-arrow:hover' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'name' => 'arrow_hborder',
                'label' => esc_html__('Border', 'ecofinecore'),
                'selector' => '{{WRAPPER}} .team-arrow-wrapper .slick-arrow:hover',
            ]
        );
        $this->add_responsive_control(
            'arrow_hradius',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-arrow-wrapper .slick-arrow:hover' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
    ...
    protected function render()
    {
        ...
        if ($settings['enable_slide'] == 'yes') {
			...
			jQuery(document).ready(function($) {
				...
				$("#team-' . esc_attr($unique) . '").slick({
                    ...
                    arrows: ' . json_encode($settings['arrow'] == 'yes' ? true : false) . ',
        ...
        ob_start();
?>
        <div class="eco-team-member-wrapper">
                ...
                <div class="<?php echo esc_attr($container); ?>">
                    <?php if ($settings['enable_title'] == 'yes') : ?>
                        <div class="team-items">
                            ...
                            ' . esc_html($settings['eco_section_stitle']) . '</' . esc_attr($settings['eco_section_stitle_tag']) . '>';
                                } ?>
                                <<?php echo esc_attr($settings['eco_section_title_tag']); ?> class="eco-t-title">
                            ...
                            <?php if ($settings['arrow'] == 'yes') : ?>
                                <div class="team-arrow">
                                    <div class="team-arrow-wrapper">
                                        <button class="team-prev"><i class="bi bi-arrow-left"></i></button>
                                        <button class="team-next"><i class="bi bi-arrow-right"></i></button>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="row" id="team-<?php echo esc_attr($unique); ?>">
                        ...
                        ?>
                            <div class="<?php echo esc_attr($column); ?>">
                                <div class="eco-team-member-items">
                                    <div class="eco-team-member-single">
                                        <div class="eco-team-image">
                                            <?php the_post_thumbnail(); ?>
                                        </div>
                                        <div class="team-content">
                                            <<?php echo esc_attr($settings['html_tag']); ?> class="team-title"><a href="<?php the_permalink(); ?>"> <?php the_title(); ?> </a></<?php echo esc_attr($settings['html_tag']); ?>>
                                            <?php if (!empty($team_meta['ecofine_team_stitle'])) : ?>
                                                <p class="team-stitle"> <?php echo esc_html($team_meta['ecofine_team_stitle']); ?> </p>
                                            <?php endif; ?>
...
Plugin::instance()->widgets_manager->register(new ecofine_Team_Widget);
