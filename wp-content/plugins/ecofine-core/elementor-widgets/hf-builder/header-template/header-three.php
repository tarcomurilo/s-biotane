...
class eco_header_template_three extends Widget_Base
{

    public function get_name()
    {
        return 'eco-header_three';
    }

    public function get_title()
    {
        return esc_html__('Eco Header Three', 'ecofinecore');
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__('Address', 'ecofinecore'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'top_list_label' => esc_html__('Address:', 'ecofinecore'),
                        'top_list_content' => esc_html__('New York 2055, USA', 'ecofinecore'),
                    ],
                    [
                        'top_list_label' => esc_html__('Hot Link:', 'ecofinecore'),
                        'top_list_content' => esc_html__('(629) 555-0129', 'ecofinecore'),
                    ],

                ],
                'title_field' => '{{{ top_list_label }}}',
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-three .header-top' => 'height: {{SIZE}}px;height-width: {{SIZE}}px;',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'   => [
                    '{{WRAPPER}} .header-three .header-top' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .header-three .header-top',
            ]
        );
        $this->add_responsive_control(
            'top_header_margin',
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .header-three .header-top' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .header-three .header-top' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-three .header-links li>i' => 'margin-right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'top_left_contact_gap',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-links li:not(:last-child)' => 'margin-right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-logo a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .header-three .header-three-style',
                'separator' => 'before',
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            'menu_box_border_radius',
            [
                'label' => esc_html__('Border Radius', 'ecofinecore'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .header-three .header-three-style' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .header-three .header-three-style' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .header-three .header-three-style' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->start_controls_tabs(
                                    ...
                                    <ul>
                                        <?php foreach ($settings['top_list'] as $topItem) : ?>
                                            <li>
                                                ...
                                                <?php echo wp_kses_post($topItem['top_list_content']); ?>
                                            </li>
                                        <?php endforeach ?>
                                    </ul>
                                </div>
...
Plugin::instance()->widgets_manager->register(new eco_header_template_three);
?>