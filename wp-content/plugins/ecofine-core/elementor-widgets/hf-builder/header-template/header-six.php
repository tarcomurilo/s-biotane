...
class eco_header_template_six extends Widget_Base
{

    public function get_name()
    {
        return 'eco-header_six';
    }

    public function get_title()
    {
        return esc_html__('Eco Header SIx', 'ecofinecore');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-six .sticky-wrapper.sticky .menu-area' => 'background-color: {{VALUE}}',
                ],
                'condition' => [
                    'sticky_menu' => 'yes',
                ],
        ...
        $this->add_control(
            'enable_searchbar',
            [
                'label' => esc_html__('Enable Search Bar', 'ecofinecore'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'ecofinecore'),
                'label_off' => esc_html__('Hide', 'ecofinecore'),
                'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'   => [
                    '{{WRAPPER}} .header-top-bar-six' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .header-top-bar-six' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .header-top-bar-six' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'        => Controls_Manager::COLOR,
                'selectors'   => [
                    '{{WRAPPER}} .header-links li a' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-social a' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'top_social_icon_width',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-social a' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'top_social_icon_background',
                'label' => esc_html__('Background Color', 'ecofinecore'),
        ...
        $this->add_responsive_control(
            'top_social_icon_border_radius',
            [
                'label'      => esc_html__('Border Radius', 'ecofinecore'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .header-social a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'top_social_icon_background_hover',
                'label' => esc_html__('Background Color', 'ecofinecore'),
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .header-social a:hover',
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .header-six-section .menu-area',
                'separator' => 'before',
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .header-six-section .menu-area' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .header-six-section .menu-area' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->start_controls_tabs(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-section.header-six .main-menu ul li.current-menu-item a' => 'color: {{VALUE}} !important',
                    '{{WRAPPER}} .header-section.header-six .main-menu ul li.current_page_item a' => 'color: {{VALUE}} !important',
                ],
            ]
        );
    ...
    ==============================-->
        <header class="header-section header-six">
            <div class="header-six-section">
                ...
                <?php endif ?>
                <div class="sticky-wrapper" id="<?php echo esc_attr($settings['sticky_menu'] == 'yes' ? 'sticky-menu' : 'no-sticky'); ?>">
                    <div class="menu-area ">
                        <div class="container ">
                            <div class="row align-items-center justify-content-between">
                                ...
                                <?php if ($settings['enable_searchbar'] == 'yes' || $settings['enable_cta_button'] == 'yes') : ?>
                                    <div class="col-auto d-none d-xl-flex align-items-center">
                                        <?php if ($settings['enable_searchbar'] == 'yes') : ?>
                                            <div class="button-six search-open">
                                                <i class="fas fa-search"></i>
                                            </div>
                                        <?php endif; ?>

                                        <?php if ($settings['enable_cta_button'] == 'yes') : ?>
...
Plugin::instance()->widgets_manager->register(new eco_header_template_six);
?>