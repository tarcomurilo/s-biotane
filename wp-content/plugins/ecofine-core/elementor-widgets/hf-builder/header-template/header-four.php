...
class eco_header_template_four extends Widget_Base
{

    public function get_name()
    {
        return 'eco-header_four';
    }

    public function get_title()
    {
        return esc_html__('Eco Header Four', 'ecofinecore');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'   => [
                    '{{WRAPPER}} .header-four .header-top-bar' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .header-four .header-top-bar',
            ]
        );
        $this->add_responsive_control(
            'top_header_margin',
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .header-four .header-top-bar' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .header-four .header-top-bar' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'label_style',
            [
                'label'     => esc_html__('Label Style', 'ecofinecore'),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name'     => 'top_contact_label_typo',
                'selector' => '{{WRAPPER}} .header-links li span',
            ]
        );
        $this->add_responsive_control(
            'top_content_label_color',
            [
                'label'       => esc_html__('Color', 'ecofinecore'),
                'type'        => Controls_Manager::COLOR,
                'selectors'   => [
                    '{{WRAPPER}} .header-links li span' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
                                    ...
                                    <div class="header-links">
                                        <ul>
                                            <?php foreach ($settings['top_list'] as $topItem) : ?>
                                                <li>
                                                    <span> <?php echo esc_html($topItem['top_list_label']); ?></span>
...
Plugin::instance()->widgets_manager->register(new eco_header_template_four);
?>