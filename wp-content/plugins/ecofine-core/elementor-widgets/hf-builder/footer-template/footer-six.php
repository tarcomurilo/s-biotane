...
class footer_six_widget extends Widget_Base
{
    ...
    {
        return esc_html__('Eco Footer Template V6 ', 'ecofinecore');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'enable_top_logo',
            [
                'label' => esc_html__('Enable Logo', 'eduplscore'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'eduplscore'),
                'label_off' => esc_html__('Hide', 'eduplscore'),
                'return_value' => 'yes',
                'default' => 'yes',
            ]
        );
            ...
            [
                ...
                'default' => [
                    [
                        ...
                        'ft_des' => esc_html__('Maple Tampa, FL 3634', 'ecofinecore'),
                    ],
                    [
                        'ft_title' => esc_html__('E-mail Address', 'ecofinecore'),
                        'ft_des' => esc_html__('exampul@gmail.com', 'ecofinecore'),
                    ],
                    [
                        'ft_title' => esc_html__('Phone Number', 'ecofinecore'),
                        'ft_des' => esc_html__('(+189) 2538-2145', 'ecofinecore'),
                    ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('It is a long established fact that a reader will be distracted typically offer a range sed et libero', 'ecofinecore'),
            ]
        );
        $this->add_control(
            'social_options',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types'    => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .footer-six-wrapper',
            ]
        );
        $this->add_responsive_control(
            'footer_box_margin',
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .footer-six-inner-section' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .footer-six-inner-section' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .footer-six-top' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__('Background', 'ecofinecore'),
                'types'    => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .ft-six-top-info',
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .ft-six-top-info' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .ft-six-top-info' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .ft-six-top-info' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle'    => true,
                'selectors' => [
                    '{{WRAPPER}} .ft-six-top-info' => 'align-items: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .ft-six-top-icon',
            ]
        );
        $this->add_responsive_control(
            'icon_width',
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .ft-six-top-icon' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .ft-six-top-icon' => 'min-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .ft-six-top-icon' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ft-six-top-icon' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .ft-six-top-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .ft-six-top-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .ft-six-top-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ft-six-top-icon svg' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'about_dec_typo',
                'label' => esc_html__('Typography', 'ecofinecore'),
                'selector' => '{{WRAPPER}} .footer-six-about-text',
            ]
        );
        $this->add_responsive_control(
            'about_dec_color',
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .footer-six-about-text' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .footer-six-about-text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .footer-six-about-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .footer-six-copyright-area',
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .footer-six-copyright-area' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .footer-six-copyright-area' => 'Padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->start_controls_tabs(
...
?>
        ...
        <footer class="footer-six-wrapper">
            <div class="footer-six-inner-section">
                <div class="container">
                    <div class="footer-six-top">
                        <?php if ($settings['enable_top_logo'] == 'yes') :
                            if (!empty($settings['ft_image'])) : ?>
                                <div class="footer-six-top-logo">
                                    <?php echo wp_get_attachment_image($settings['ft_image']['id'], 'full'); ?>
                                </div>
                        <?php endif;
                        endif; ?>
                        <div class="footer-six-top-content">
                            <div class="row">
                                <?php foreach ($settings['ft_icon_box_list'] as $icon_list) : ?>
                                    <div class="col-lg-4 col-md-6 col-12 footer-six-coloum">
                                        <div class="ft-six-top-info">
                                            <div class="ft-six-top-icon">
                                ...
                                <div class="col-md-6 col-xl-3">
                                    <div class="widget footer-two-widget">
                                        <div class="widget-about">
                                            ...
                                            <div class="footer-six-about-text"> <?php echo wp_kses($settings['about_widget_des'], $allowed_html); ?> </div>
            ...
            <div class="copyright-wrap">
                <div class="container">
                    <div class="footer-six-copyright-area">
...
Plugin::instance()->widgets_manager->register(new footer_six_widget);
