...
class footer_one_widget extends Widget_Base
{
    ...
    {
        return esc_html__('Eco Footer Template V1 ', 'ecofinecore');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'select_logo',
            [
                'label'   => __('Select Logo Or Title', 'ecofinecore'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'logo',
                'options' => [
                    'logo'   => __('Logo', 'ecofinecore'),
                    'title'   => __('Title', 'ecofinecore'),
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('It is a long established fact that a reader will be distracted and typically offer a range', 'ecofinecore'),
            ]
        );
        $this->add_control(
            'button_Text',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    ...
                    [
                        'ecofin_social_icon' => 'fab fa-linkedin-in',
                    ],
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .copyright-one-wrap',
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => __('Social Normal', 'ecofinecore'),
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .social-icons ul li a' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .social-icons ul li a' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .social-icons ul li a' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .social-icons ul li a' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => __('Social Hover', 'ecofinecore'),
            ]
        );
        $this->add_responsive_control(
            'social_icon_hcolor',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .social-icons ul li a:hover' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Border', 'ecofinecore'),
                'selector' => '{{WRAPPER}} .social-icons ul li a:hover',
            ]
        );
        $this->add_responsive_control(
            'social_icon_hradius',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .social-icons ul li a:hover' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
                            ...
                            <div class="row justify-content-between">
                                <div class="col-md-6 col-xl-3">
                                    <div class="widget footer-two-widget">
                                        <div class="widget-about">
                                            <?php if ($settings['select_logo'] == 'logo') : ?>
                                                <div class="f-one-about-img">
                                                    <?php echo wp_get_attachment_image($settings['fabout_logo']['id'], 'full'); ?>
                                                </div>
                                            <?php endif; ?>
                                            <?php if ($settings['select_logo'] == 'title') : ?>
                                            ...
                                            <?php endif; ?>
                                            <div class="footer-two-about-text"> <?php echo wp_kses($settings['about_widget_des'], $allowed_html); ?> </div>
                                ...
                                <div class="col-md-6 col-xl-3">
                                    <div class="widget footer-two-widget">
                                        ...
                                        <div class="footer-two-newslatter-des"> <?php echo esc_html($settings['newslatter_widget_des']); ?> </div>
            ...
            <div class="copyright-one-wrap">
                <div class="container">
                    <div class="footer-one-copyright-area">
                        <div class="footer-two-copyright-text"> <?php echo wp_kses($settings['Copyright'], $allowed_html); ?></div>
                        <?php if (!empty($settings['menu_item_list'])) : ?>
                            <div class="footer-menu">
                                <ul class="ftmenu">
                                    <?php foreach ($settings['menu_item_list'] as $list) :
                                        $url      = $list['menu_item_url']['url'];
                                        $target   = $list['menu_item_url']['is_external'] ? ' target="_blank"' : '';
                                        $nofollow = $list['menu_item_url']['nofollow'] ? ' rel="nofollow"' : '';
                                    ?>
                                        <li><a href="<?php echo esc_url($url); ?>" <?php echo $target . $nofollow; ?>><?php echo esc_html($list['menu_item']); ?></a></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                        <?php endif; ?>
...
Plugin::instance()->widgets_manager->register(new footer_one_widget);
