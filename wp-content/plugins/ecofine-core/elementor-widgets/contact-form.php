...
class contact_form_widget extends Widget_Base
{
	...
	{
		return esc_html__('Eco Contact Form', 'ecofinecore');
	}
	...
	protected function register_controls()
	{
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Ecofine Contact Form', 'ecofinecore'),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__('talk to us', 'ecofinecore'),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __('Join our Organization', 'ecofinecore'),
				'label_block' => true,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__('57/9 anytime open our organization', 'ecofinecore'),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .contact-form-area' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .contact-form-area' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .contact-form-area',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .contact-form-area' => 'text-align: {{VALUE}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			'top-area_content',
			[
				'label' => __('Top Content Area', 'ecofinecore'),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .contact-form-top-area' => 'text-align: {{VALUE}};',
				],
				'separator' => 'before',
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label'    => __('Background', 'ecofinecore'),
				'types'    => ['classic', 'gradient'],
				'selector' => '{{WRAPPER}} .contact-form-top-area',
			]
		);
		$this->add_responsive_control(
			'tp_content_padding',
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .contact-form-top-area' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .contact-form-top-area' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .contact-form-stitle',
			]
		);
		$this->add_responsive_control(
			'stitle_color',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .contact-form-stitle' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors' => [
					'{{WRAPPER}} .contact-form-stitle' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors' => [
					'{{WRAPPER}} .contact-form-stitle' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors' => [
					'{{WRAPPER}} .contact-form-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors' => [
					'{{WRAPPER}} .contact-form-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_group_control(
			...
			[
				'name' => 'des_typo',
				'label' => esc_html__('Typography', 'ecofinecore'),
				'selector' => '{{WRAPPER}} .contact-form-des',
			]
		);
		$this->add_responsive_control(
			'des_color',
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .contact-form-des' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors' => [
					'{{WRAPPER}} .contact-form-des' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors' => [
					'{{WRAPPER}} .contact-form-des' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .contact-form-wrapper form.wpcf7-form label' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .contact-form-wrapper form.wpcf7-form label' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .contact-form-wrapper form.wpcf7-form label',
			]
		);
		$this->add_group_control(
			Group_Control_Border::get_type(),
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .contact-form-wrapper form.wpcf7-form label' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
				],
				'separator' => 'before',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .contact-form-wrapper form.wpcf7-form label' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .contact-form-wrapper form.wpcf7-form label' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
...
?>
		<div class="contact-form-wrapper">
			<div class="contact-form-top-area">
				<div class="contact-form-stitle"> <?php echo esc_html($settings['stitle']); ?> </div>
				<div class="contact-form-title"> <?php echo esc_html($settings['title']); ?> </div>
				<div class="contact-form-des"> <?php echo esc_html($settings['content']); ?> </div>
			</div>
