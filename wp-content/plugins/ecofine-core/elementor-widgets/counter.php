...
class ecofine_counter_widget extends Widget_Base
{

	public function get_name()
	{
		return 'thenepul_counter';
	}

	public function get_title()
	{
		return esc_html__('Eco Counter', 'ecofinecore');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .eco-counter-wrapper .eco-counter-items',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'toggle'    => true,
				'selectors' => [
					'{{WRAPPER}} .eco-counter-wrapper .eco-counter-items' => 'text-align: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .eco-counter-wrapper .eco-counter-items' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .eco-counter-wrapper .eco-counter-items' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .eco-counter-wrapper .eco-counter-items' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .eco-counter-item .eco-counter-icon' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .eco-counter-item .eco-counter-icon' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .eco-counter-item .eco-counter-icon' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .eco-counter-item .eco-counter-icon' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .eco-counter-item .eco-counter-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .eco-counter-item .eco-counter-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .eco-counter-item .eco-counter-icon svg' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .eco-counter-item .eco-counter-icon svg' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .eco-counter-item .eco-counter-title' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
			...
			[
				'name'     => 'title_typo',
				'label'    => esc_html__('Title Typography', 'ecofinecore'),
				'selector' => '{{WRAPPER}} .eco-counter-item .eco-counter-title',
			]
		);
		$this->add_responsive_control(
			'title_margin',
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .eco-counter-item .eco-counter-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .eco-counter-item .eco-counter-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
	...
	protected function render()
	{
		...
		ob_start();
?>
		<div class="eco-counter-wrapper eco-counter-box-<?php echo esc_attr($count_id); ?>">
							...
							<div class="eco-counter-items">
								<div class="eco-counter-item">
									<?php if (!empty($item['icon']['value'])) : ?>
										<div class="eco-counter-icon">
											<?php \Elementor\Icons_Manager::render_icon($item['icon'], ['aria-hidden' => 'true']); ?>
										</div>
									<?php endif; ?>
									<div class="eco-counter-content count-process">
										<div class="eco-counter-numner">
											<h2 class="eco-count-timer timer" data-to="<?php echo esc_attr($item['number']); ?>" data-speed="5000">
										...
										<?php if (!empty($item['title'])) : ?>
											<<?php echo esc_attr($settings['counter_title_tag']); ?> class="eco-counter-title">
												<?php echo esc_html($item['title']); ?>
											</<?php echo esc_attr($settings['counter_title_tag']); ?>>
										<?php endif; ?>
									</div>
								</div>
							</div>
...
Plugin::instance()->widgets_manager->register(new ecofine_counter_widget);
