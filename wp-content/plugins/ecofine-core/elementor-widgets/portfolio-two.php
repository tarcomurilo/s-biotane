...
class eco_portfolio_two_Widget extends Widget_Base
{

    public function get_name()
    {

        return 'eco_portfolio_two';
    }

    public function get_title()
    {
        return esc_html__('Eco Portfolio V2', 'ecofinecore');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .portfolio-menu-two ul li',
            ]
        );
        $this->add_responsive_control(
            'menu_color',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .portfolio-menu-two ul li' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .portfolio-menu-two ul li.active' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            'menunote_bg',
            [
                'label' => __('Active Background', 'ecofinecore'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name'     => 'menu_backgrounds_active',
                'label'    => esc_html__('Background', 'ecofinecore'),
                'types'    => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .portfolio-menu-two ul li:active',
                'separator' => 'before',
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .portfolio-menu-two ul li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .portfolio-menu-two ul li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
...
?>
        ...
        <div class="eco-portfolio-two-wrapper">
            <div class="<?php echo esc_attr($container); ?>">
                <div class="row">
                    <div class="col-xl-3 col-lg-4  col-12">
                        <?php if ($settings['enable_menu'] == 'yes') : ?>
                            <div class="portfolio-menu-two">
                                        ...
                                        <div class="eco-portfolio-content-wrp">
                                            ...
                                            <div class="eco-portfolio-content">
                                                <div class="item-content-heading">
                                                    ...
                                                    <?php endif; ?>
                                                    <<?php echo esc_attr($settings['html_tag']); ?> class="project-title"><a href="<?php echo the_permalink(); ?>"><?php echo wp_trim_words(get_the_title(), esc_html($settings['title_lanth'])); ?></a> </<?php echo esc_attr($settings['html_tag']); ?>>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
Plugin::instance()->widgets_manager->register(new eco_portfolio_two_Widget);
