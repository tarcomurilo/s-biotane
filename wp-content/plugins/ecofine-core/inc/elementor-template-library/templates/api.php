...
class Api extends Source_Base {
	...
	const LIBRARY_OPTION_KEY = 'ecofine_library_info';

	const LIBRARY_TIMESTAMP_CACHE_KEY = 'ecofine_remote_update_timestamp';

    //Change Template link
    const API_INFO_URL = 'https://data.themepul.dev/ecofine/';

	public function get_id() {
		return 'ecofine-library';
	}

	public function get_title() {
		return esc_html__( 'Ecofine Library', 'themepul-core' );
	}
	...
	public function get_data( array $args, $context = 'display' ) {
		...
		if ( empty( $data ) || empty( $data['content'] ) ) {
			throw new \Exception( __( 'Template does not have any content', 'themepul-core' ) );
		}
